    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription className="space-y-4 pt-3 text-black text-center">
            <p>Sua inscrição foi submetida com sucesso.</p>
            <p>
            ...
            <p>
              Confirmaremos a sua inscrição assim que recebermos a confirmação
              do pagamento.
            </p>
          </DialogDescription>
        </DialogHeader>
